...
function ProductActions({ product, manufacturerSlug, primary, variationCount = 0 }: { product:LibraryProduct; manufacturerSlug:string; primary:string; variationCount?:number }) {
  ...
  return <div className="flex flex-wrap items-center gap-1 text-[11px] font-extrabold uppercase text-black/60 [&_a]:rounded-md [&_a]:px-2.5 [&_a]:py-2 [&_a]:transition [&_a]:hover:bg-black/5 [&_a]:hover:text-black [&_button]:rounded-md [&_button]:px-2.5 [&_button]:py-2 [&_button]:transition [&_button]:hover:bg-black/5">
