"use client";
/* eslint-disable @next/next/no-img-element -- Academy product imagery is tenant-provided and may use arbitrary remote hosts. */
...
function useMotionAllowed() {
  return useSyncExternalStore(subscribeToMotionPreference, () => !window.matchMedia(reducedMotionQuery).matches, () => false);
}
